...
const App = () => (
  <Chessboard
    ...
    // such as side to move will be stripped). ['start' | 'empty'] also valid. Default: 'start'
    ...
    size={400} // String ('100%', of container element) | number (px). If expressed as a percentage,
